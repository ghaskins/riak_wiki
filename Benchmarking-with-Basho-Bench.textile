...
<div class="info"><div class="title">Note on Documentation</div>What follows is primarily a reprint of what can be found in the basho_bench repository under {{docs/Documentation.org}} </div>
