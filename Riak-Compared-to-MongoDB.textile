...
_[[Add Nodes to Riak|https://wiki.basho.com/display/RIAK/Basic+Cluster+Setup#BasicClusterSetup-AddaSecondNodetoYourCluster]]_
_[[Consistent Hashing|https://wiki.basho.com/display/RIAK/Riak+Glossary#RiakGlossary-ConsistentHashing]]_

As of the 1.6 release, MongoDB offers several options for replication:

* Master/Slave

_[[http://www.mongodb.org/display/DOCS/Master+Slave]]_
...
_[[http://www.mongodb.org/display/DOCS/Replica+Sets]]_

While Master/Slave replication is still supported, Replica sets adds auto failover so it's expected that most users will migrate to this configuratoin. However, in certain use cases traditional M/S is more appropriate and will still be supported. 
...
_[[http://www.mongodb.org/display/DOCS/Sharding]]_
_[[http://www.mongodb.org/display/DOCS/Sharding+Introduction]]_
_[[http://en.wikipedia.org/wiki/Sharding]]_
...
_[[http://www.mongodb.org/display/DOCS/Configuring+Sharding#ConfiguringSharding-Removingashard]]_
...
_[[http://www.mongodb.org/display/DOCS/Durability+and+Repair]]_
_[[http://blog.mongodb.org/post/381927266/what-about-durability]]_
...
_[[Data Storage in Riak|https://wiki.basho.com/display/RIAK/An+Introduction+to+Riak#AnIntroductiontoRiak-DataStorage]]_
...
_[[http://www.mongodb.org/display/DOCS/Indexes]]_
_[[http://www.mongodb.org/display/DOCS/Querying]]__[[http://www.mongodb.org/display/DOCS/MapReduce]]_
...
_[[http://wiki.basho.com/display/RIAK/Riak+Glossary#RiakGlossary-VectorClock|http://wiki.basho.com/display/RIAK/Riak+Glossary#RiakGlossary-VectorClock]]_

Mongo uses a "last one wins" technique for conflict resolution.

_[[http://www.mongodb.org/display/DOCS/Atomic+Operations]]_
...
*HTTP* (_[[https://wiki.basho.com/display/RIAK/REST+API|https://wiki.basho.com/display/RIAK/REST+API]]_) and *Protocol Buffers* (_[[http://wiki.basho.com/display/RIAK/PBC+API|http://wiki.basho.com/display/RIAK/PBC+API]]_)
...
_[[http://www.mongodb.org/display/DOCS/Mongo+Wire+Protocol]]_