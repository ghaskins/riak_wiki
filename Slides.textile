{excerpt}This is a sample of the slide decks used in presentations given by Riak Core Developers and Developer Advocates, and members of the Riak Community at conferences, meetups, and various other events worldwide.{excerpt} 

If you're looking to learn more about Riak (and happen to like slides), chances are you'll find something here that will help. This should also serve as a great starting point for anyone wanting some guidance when building a slide deck of their own.

_If you have a set of slides that you want included here, email *wiki@basho.com* with the info and we'll post them._
...
* [[Riak from the Inside (PDF Download)|^RiakInside.pdf]] - Coming in at just under 30 slides, this deck was delivered by Justin Sheehy at a recent Erlang Factory. These are an extensive and valuable overview of Riak's internals.
