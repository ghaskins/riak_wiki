...
<div class="info"> Riak comes with some prebuilt JavaScript Functions. You can check them out at: [[http://hg.basho.com/riak_kv/src/tip/priv/mapred_builtins.js|http://hg.basho.com/riak_kv/src/tip/priv/mapred_builtins.js]] </div>
...
<div class="info">There is a small group of prebuilt Erlang MapReduce functions available with Riak. Check them out here: [[http://bitbucket.org/basho/riak_kv/src/tip/src/riak_kv_mapreduce.erl|http://bitbucket.org/basho/riak_kv/src/tip/src/riak_kv_mapreduce.erl]]</div>
