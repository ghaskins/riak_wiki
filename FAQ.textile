h3. Why did you build Yet Another Data Store?
...
h3.  But what about (insert favorite "nosql" system here)?
...
h3.  Do I have to know how to write distributed Erlang code to use Riak?
...
h3.  Is Version 0.x ready for my production data?
...
h3.  How large of a file can one store in Riak? Any guidelines or recommendations?
...
h3.  I wrote a great piece of code for Riak. How do I contribute it?

See [[Code Submission and Integration]].

h3.  What is the maximum number of partitions allowable in a Riak cluster?
...
h3.  What is the largest cluster currently running?
...
h3.  Why did you chose to support JavaScript (in addition to Erlang) for MapReduce?
...
h3.  Can I delete an entire bucket?
...
h3.  How can I authenticate users who are accessing Riak?
