...
h5. Why did you build Yet Another Data Store?
...
h5. Do I have to know how to write distributed Erlang code to use Riak?

I believe you don't, Bob.  Riak provides a simple and convenient programming interface over HTTP and JSON. This, combined with our [[rapidly expanding suite of client libraries|RIAK:Client Libraries]] , makes Riak accessible to nearly every programmer on the Web.

h5. Is Version 0.x ready for my production data?
...
h5. How large of a file can one store in Riak? Any guidelines or recommendations?
...
As of Riak 0.13, the [[Luwak|RIAK:Luwak]] module provides support for large files but is disabled by default.

h5. I wrote a great piece of code for Riak. How do I contribute it?

See [[Code Submission and Integration]].

h5. What is the maximum number of partitions allowable in a Riak cluster?
...
h5. What is the largest cluster currently running?
...
h5. Why did you chose to support JavaScript (in addition to Erlang) for MapReduce?
...
h5. Can I delete an entire bucket?
...
h5. How can I authenticate users who are accessing Riak?
