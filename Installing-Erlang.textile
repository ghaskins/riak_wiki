...
<div class="info">The Riak binary packages for [[Debian and Ubuntu|RIAK:Installing on Debian and Ubuntu]], [[Mac OS X|RIAK:Installing on Mac OS X]] and [[RHEL and CentOS|RIAK:Installing on RHEL and CentOS]] do not require that you build Erlang from source. *You will have to download and install Erlang, however, if you're planning on completing [[The Riak Fast Track]].*</div>
