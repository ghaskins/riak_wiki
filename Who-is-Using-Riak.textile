...
{section}
{column:width=25%}[[/images/mozilla-foundation.png|align=center|width=110]]
{column}
...
{section}
{column:width=25%}[[/images/ws.png|align=center|vspace=35px]]
{column}
...
{section}
{column:width=25%}[[/images/hitta.png|align=center|width=110]]
{column}
...
----
{section}
{column:width=25%}[[/images/swingvine-dark.png|align=center|width=110]]
{column}
...
{section}
{column:width=25%}[[/images/rigel_group.png|align=center|width=175|vspace=35px]]
{column}
...
{section}
{column:width=25%}[[/images/gastown_white.png|align=center|width=110|vspace=20px]]
...
{section}
{column:width=25%}[[/images/wescom-logo-small.png|align=center|vspace=35px]]
{column}
...
{section}
{column:width=25%}[[/images/inagist.gif|align=center|width=110|vspace=45px]]
{column}
...
{section}
{column:width=25%}[[/images/sensi-soft.png|align=center|width=100]]
{column}
...
{section}
{column:width=25%}[[/images/tma.png|align=center|width=200|vspace=60px]]
{column}
...
{section}
{column:width=25%}[[/images/dayfindr.png|align=center|width=200|vspace=35px]]
{column}
...
{section}
{column:width=25%}[[/images/rock_of_gainesville.png|align=center|width=150|vspace=30px]]
{column}
...
{section}
{column:width=25%}[[/images/Wegeo.png|align=center|width=180|vspace=30px]]
{column}
...
{section}
{column:width=25%}[[/images/overnothing_logo.png|align=center|width=100|vspace=70px]]
{column}
