h2. {anchor:installation} Installation
...
* [[Installing from source|RIAK:Installing Riak from Source]]

h2. {anchor:startup} Starting up
...
h2. {anchor:doesitwork} Does it work?
...
{"props":{"name":"test","allow_mult":false,"big_vclock":50,"chash_keyfun":{"mod":"riak_util","fun":"chash_std_keyfun"},"linkfun":{"mod":"raw_link_walker_resource","fun":"mapreduce_linkfun"},"n_val":3,"old_vclock":86400,"small_vclock":10,"young_vclock":20},"keys":[]}{code}
...
* [[Add more nodes to your Riak cluster|RIAK:Basic Cluster Setup]]
* [[The high level overview of the Riak design and functionality|RIAK:An Introduction to Riak]]
