...
* @r@ - (read quorum) how many replicas need to agree when retrieving the object ([[default is defined by the bucket|HTTP API Set Bucket Properties]])
...
h2. Siblings examples

h3. Manually requesting siblings
...
h3. Get all siblings in one request
