...
For an example of a read/write filesystem server showing several interesting features and supporting GET, PUT, DELETE, and POST, see webmachine_demo_fs_resource.
