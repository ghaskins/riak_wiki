...
*Anthony Accardi, Engineering Lead, Swipely:* "We store data for 15 million merchants in Riak, which we can update without disturbing the critical path of responding to the user. Riak also gives us a very predictable model for scaling our service."
