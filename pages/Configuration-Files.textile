...
** *riak_kv_dets_backend_root*
    Root directory where the DETS files are stored (defualt: "data/dets"
* *riak_kv_ets_backend*
...
While both backends are now the default for all buckets, you can choose either "cache" or "bitcask" as custom values when setting bucket properties through the [[REST API]].
