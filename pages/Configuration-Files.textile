...
Override the default location of the access logs.  See the "webmachine":#webmachine-settings settings to enable access logs.
...
<div class="note">The additional disk I/O of an access log imposes a performance cost you may not whish to pay.  Therefore, by default, Riak does not produce access logs.</div>
