...
<div class="info"><div class="title">A Note on Integer Padding</div>With the current defaults, Search pads all integers to 10 characters during indexing, and you must manually pad integers to 10 characters in your queries.</div>
