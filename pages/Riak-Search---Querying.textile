...
* *q.op=OPERATION* - Allowed settings are either "and" or "or". Overrides the "default_op" setting in the schema file. Default is "or". (Note: A bug in Riak Search 0.14 causes the system to ignore this setting.)
