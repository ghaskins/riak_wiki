...
```bash
wget http://downloads.basho.com/riak-search/riak-search-0.14/riak-search_0.14.0-1_amd64.deb
sudo dpkg -i riak-search_0.14.0-1_amd64.deb
```
...
```bash
$ wget http://downloads.basho.com/riak-search/riak-search-0.13/riak-search_0.14.0-1_i386.deb
$ sudo dpkg -i riak-search_0.14.0-1_i386.deb
```
