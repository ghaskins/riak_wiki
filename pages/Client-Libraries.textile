...
The local Erlang client is a tightly-integrated part of Riak and the Riak REST interface uses the Erlang client internally. 
...
We also [[host the generated ___ client API Docs on GitHub|http://#]]
...
There is a [[PHP sample app|http://github.com/schofield/riak_php_app]] that you can check out if you want to see the PHP library in action. You can get it 
...
We also [[host the generated Python client API Docs on GitHub|http://basho.github.com/basho-riak-client]].
