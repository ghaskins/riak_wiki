This a collection of sample applications built on Riak and Riak Core. *(If you have a sample app to add, please fork the "Riak Wiki Repo on GitHub":https://github.com/basho/riak_wiki and do so.)* 
...
* [[selusuh|https://bitbucket.org/OJ/selusuh]] - Riak application which presents JSON slide decks (thanks, "OJ":http://twitter.com/#!/thecolonial!)
...
* [[basho_banjo|https://github.com/rklophaus/BashoBanjo]] - An application that uses Riak Core to play distributed music
