h2. Quickstart Examples

The [[Quickstart|Webmachine---Quickstart]] guide walks through setting up the [[demo|https://github.com/basho/webmachine/tree/master/demo]] application from the Webmachine repository. The demo application provides two basic example resources:
