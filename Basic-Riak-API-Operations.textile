...
{toc:minlevel=3|indent=1.5em}

\\
{note:title=Required Knowledge}
...
* *URL Escaping* \- Buckets, keys, and link specifications may not contain unescaped slashes. Use a URL-escaping library or replace slashes with %2F.{note}
...
{info}{{POST}} is also a valid verb, for compatibility's sake.{info}
...
* [[The REST API In Depth|REST API]]
...
* [[Why Vector Clocks are Hard|http://blog.basho.com/2010/04/05/why-vector-clocks-are-hard/]] (from the Basho Blog)
{info}
